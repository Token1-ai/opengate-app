/**
 * OpenGate Battleship Oracle — Polygon regular table
 * File: api/oracle-polygon.js
 *
 ...
 *     BNB, offset by POLYGON_OFFSET so contract_game_id ranges never
...
const BATTLESHIP_CONTRACT = '0x22597403bFa0982803Be28D070a14b6E45700dc0'; // regular table
...
const POLYGON_OFFSET = 3000000000; // keeps this table's DB ids out of BNB's ranges (0 and 2,000,000,000)
...
module.exports = async function handler(req, res) {
  ...
  const DB_GID = POLYGON_OFFSET + Number(gameId);
