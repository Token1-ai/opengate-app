/**
 * OpenGate Battleship Oracle — Base GOLD VIP table
 * File: api/oracle-gold-base.js
 *
...
const BASE_OFFSET = 6000000000; // Base Gold — out of BNB(0), BNB Gold(2B), Polygon(3B), Polygon Gold(4B), Base regular(5B)
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    // Gold VIP table — no stake cap (only Gold Pass holders can play here).
    ...
    console.error('[Oracle-Gold-Base Error]', err);
